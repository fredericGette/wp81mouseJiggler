...
{
	BYTE* p1 = (BYTE*)malloc(16);
	BYTE* p2 = (BYTE*)malloc(16);
	BYTE* temporaryKey = (BYTE*)malloc(16);
	BYTE* cipher = (BYTE*)malloc(16);
	...
	// "Just Works STK generation method"
	// TK=0x00000000000000000000000000000000
	memset(temporaryKey, 0, 16);

	// cipher1 = e(temporaryKey, r XOR p1)
	aes128e(cipher, p1, temporaryKey);

	// p2 = e(k, r XOR p1) XOR p2
	for (int i = 0; i < 16; i++)
	{
		p2[i] = cipher[i] ^ p2[i];
	}

	// confirmValue = e(k, e(k, r XOR p1) XOR p2)
	aes128e(confirmValue, p2, temporaryKey);
...
{
	BYTE* temporaryKey = (BYTE*)malloc(16);
	BYTE* r = (BYTE*)malloc(16);

	// "Just Works STK generation method"
	// TK=0x00000000000000000000000000000000
	memset(temporaryKey, 0, 16);

	// r = sRand(64bits) || mRand (64bits)
	for (int i = 0; i < 16; i++)
	{
		if (i < 8)
		{
	...
	// stkValue = s1(TK, sRand, mRand) = e(TK, r)
	aes128e(stkValue, r, temporaryKey);
